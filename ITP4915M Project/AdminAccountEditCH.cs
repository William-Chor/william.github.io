...
{
    public partial class AdminAccountEditCH : Form
    {
        public AdminAccountEditCH()
        {
            InitializeComponent();
        ...
        {
            AdminAccountEdit ed = new AdminAccountEdit();
            ed.Show();
            this.Hide();
        }
        ...
        private void AdminAccountEditCH_Load(object sender, EventArgs e)
        {
            // center the windows
