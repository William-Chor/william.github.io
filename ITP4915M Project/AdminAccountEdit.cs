...
{
    public partial class AdminAccountEdit : Form
    {
        public AdminAccountEdit()
        {
            InitializeComponent();
        ...
        {
            AdminAccountEditCH edch = new AdminAccountEditCH();
            edch.Show();
            this.Hide();
        }
        ...
        private void AdminAccountEdit_Load(object sender, EventArgs e)
        {
            // center the windows
