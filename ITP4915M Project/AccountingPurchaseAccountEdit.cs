...
{
    public partial class AccountingPurchaseAccountEdit : Form
    {
        public AccountingPurchaseAccountEdit()
        {
            InitializeComponent();
        ...
        {
            AccountingPurchaseAccountEditCH apaech = new AccountingPurchaseAccountEditCH();
            apaech.Show();
            this.Hide();
        }

        private void AccountingPurchaseAccountEdit_Load(object sender, EventArgs e)
        {
            // center the windows
